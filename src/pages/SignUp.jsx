              ...
              <div className="max-w-sm mx-auto">
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button className="btn text-white bg-accent1 hover:bg-green-600 w-full">Sign up</button>
                    </div>
                  </div>
                ...
                <form>
                  <div className="flex flex-wrap -mx-3 mb-3">
                    <div className="w-full px-3">
                      <button className="btn px-0 text-white bg-gray-900 hover:bg-green-600 w-full relative flex items-center">
